...
_reg(
    MonitorType(
        ...
        ["mechanical"],
        3000,
        "Fire sprinkler flow monitoring",
        "L/min",
        (1.0, 0.4, 0.4),
    )
)
...
_reg(
    MonitorType(
        ...
        ["entrance", "office"],
        1800,
        "Glass break acoustic detection",
        "bool",
        (0.6, 0.4, 0.6),
    )
)
...
_reg(
    MonitorType(
        "blind_actuator",
        "Smart Blind Actuator",
        MonitorCategory.SMART,
        "IfcActuator",
        "BLINDACTUATOR",
        ["office", "meeting", "living"],
        6000,
        "Motorised blind/shade control",
        "%",
        (0.7, 0.7, 0.3),
    )
)
