...
### 自我審計階段
11. **★ 產生 `docs/audit-reports/Sprint{X}_AuditReport.md`（代碼 + 文檔 8/8 + Xcode 8/8）★**
12. **★ 如有建議，產生 `sprints/PROMPT_P{X}.1.md` ★**
13. echo 審計報告 + 評分
...
### 完成階段
18. 建立下一個 PROMPT（通過合規性檢查，存放在 `sprints/`）✅
...
*CLAUDE.md v1.15.0 | 2026-03-26 | 新增: 專案檔案夾架構與檔名規則（Sprint Prompt → sprints/, Audit Report → docs/audit-reports/）*
