...
**P14** — CI/CD + 安全強化 + 文件 v2.0（PROMPT_P14.md 已在 GitHub）

```bash
cd ~/Documents/MyProjects/PromptBIMTestApp1 && git pull origin main && conda activate promptbim
claude --dangerously-skip-permissions -p "請讀取 PROMPT_P14.md 並執行所有 task。不要問任何問題。"
```
...
| 文件 | 用途 |
|------|------|
| `CLAUDE.md` v1.6.0 | Claude Code 行為規範（含 Sprint 完成輸出模板）|
| `SKILL.md` | 專案 SSOT |
